  ...
  <div>
    <section class="h-screen bg-gray-100 py-12 sm:py-16 lg:py-20">
      <div class="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto mt-8 max-w-2xl md:mt-12" v-if="products.length > 0">
          <div class="bg-white shadow">
            <div class="px-4 py-6 sm:px-8 sm:py-10">
              <div class="flow-root">
                <ul class="-my-8" v-for="(product, index) of products">
                    ...
                    <div class="relative flex flex-1 flex-col justify-between">
                      <div class="sm:col-gap-5 sm:grid sm:grid-cols-2">
                        <div class="pr-8 sm:pr-5">
                          <p class="text-base font-semibold text-gray-900">{{ product.title }}</p>
        ...
        <div class="flex items-center justify-center mx-auto mt-8 max-w-2xl md:mt-12" v-else>
          <p class="text-base font-sans">You do not have a selected product</p>
        </div>
      </div>
    </section>
