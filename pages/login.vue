          ...
          <div class="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
            ...
            <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
              ...
              <div class="flex flex-row items-center mt-4">
                <p class="font-roboto text-sm text-gray-800  dark:text-indigo-50 m-2">Already have not an account</p>
                <nuxt-link to="/register" class="sign_in_here m-2 text-indigo-800  dark:text-indigo-300"> Sign up here </nuxt-link>
              </div>
            </div>
          </div>
