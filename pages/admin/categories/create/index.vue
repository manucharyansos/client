...
<!--            />-->
<!--            <img :src="category.imageUrl" alt="Selected Image">-->
<!--&lt;!&ndash;            <img :src="`http://127.0.0.1:8000/user-images/${category.imageUrl}`" alt="Selected Image">&ndash;&gt;-->
<!--          </label>-->
<!--        </div>-->

<!--        <div class="relative mx-10 my-12 border-gray-600 shadow-xl md:w-1/2 w-full">-->
<!--          <input-->
<!--            type="text"-->
<!--            id="name"-->
