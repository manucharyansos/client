<template>
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      <tbody v-for="(product, index) of getProducts" :key="index">
      <tr class="w-full bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <th
          scope="row"
          class="px-6 py-4 w-32 h-24 font-medium text-gray-900 whitespace-nowrap dark:text-white"
          >
          <img class="w-16 h-16 object-cover object-center" :src="getFirstImage(product)" alt="">
        </th>
        <td class="px-6 py-4">
          {{ product.title }}
        </td>
