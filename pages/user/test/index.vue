...
<!--              </tr>-->
              ...
              <tbody>
              <tr v-for="(product, index) of getProducts" :key="index" class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                <td class="p-4 w-4">
                  <div class="flex items-center">
                ...
                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                  <div class="flex items-center mr-3">
                    <img :src="getFirstImage(product)" alt="iMac Front Image" class="h-8 w-auto mr-3">
                    {{ product.title }}
                  </div>
                </th>
                <td class="px-4 py-3">
                  <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ product.category_id }}</span>
                </td>
                ...
                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                  <div class="flex items-center space-x-4">
                    <button
                      ...
                      class="py-2 px-3 flex items-center text-sm font-medium text-center text-blue-600 bg-white rounded-lg border border-blue-600 hover:bg-primary-800 hover:text-white focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
          ...
          <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
              ...
              of
              <span class="font-semibold text-gray-900 dark:text-white">{{ getProducts.length }}</span>
            </span>
    ...
    <!-- End block -->
    <div id="createProductModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-14 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] md:h-full">
    ...
    <div id="drawer-update-product" class="fixed top-0 left-0 z-50 w-full h-screen max-w-3xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-product-label" aria-hidden="true">
      ...
      <button @click="removeSelectedProduct" type="button" data-drawer-dismiss="drawer-update-product" aria-controls="drawer-update-product" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
        </svg>
...
<!--                </button>-->
<!--                <div id="tooltip-fullscreen" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0 auto auto 0; margin: 0; transform: translate3d(0px, 335px, 0px);">-->
<!--                  Show full screen-->
<!--                  <div class="tooltip-arrow" data-popper-arrow=""></div>-->
<!--                </div>-->
<!--              </div>-->
          ...
          <div class="mb-4">
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
              <div v-for="image of selectedProduct.images" class="relative p-2 bg-gray-100 rounded-lg sm:w-36 sm:h-36 dark:bg-gray-700">
                <img :src="`http://127.0.0.1:8000/products-images/${image.image_path}`" alt="imac image" class="w-full object-cover object-center">
...
export default {
  ...
  methods :{
    ...mapActions('products', ['fetchProducts', 'deleteSelectedProduct']),
