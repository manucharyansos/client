...
<!--    </div>-->
      ...
      <button @submit.prevent="submitReview" type="submit">Submit Review</button>
...
export default {
  ...
  computed: {
    ...mapGetters('guests/products', ['getProducts'])
  },
  methods: {
    ...mapActions('guests/products', ['reviewProduct', 'fetchProducts']),
    async submitReview() {
