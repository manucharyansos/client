<template>
  <div class="mx-12">
    ...
    <div v-for="subcategory of getCategoryWithProducts.subcategories">
      <div class="grid md:grid-cols-2">
        <div class="flex flex-col items-center justify-center">
          ...
          <p v-if="getCategoryWithProducts.description">
            {{ subcategory.description }}
          </p>
        </div>
        <div class="flex items-center justify-center">
          <img v-if="subcategory.image" class="object-cover object-center w-full h-full m-8" :src="`http://127.0.0.1:8000/category-images/${subcategory.image}`" alt="">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-4 h-full mx-auto flex flex-wrap mb-4">
        <div
          ...
          v-for="(product, index) of subcategory.products"
          :key="index"
        >
          <ProductContent
